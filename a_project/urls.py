...
from school import attendance_views, calendar_views, dashboard_views, exam_views, finance_views, library_views, login_views, message_views, notice_views, promotion_views, staff_card_views, staff_list_views, student_card_views
